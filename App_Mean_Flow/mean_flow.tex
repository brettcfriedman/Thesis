...
\beq
\label{force_drift}
v_f = \frac{1}{q} \frac{{\bf F \times B}}{B^2}.
\eeq
...
\beq
\label{en_mean_advec}
- \int_V \left( \frac{T_{e0}}{N_0} N {\mathbf v_{E0}} \cdot \grad N \right) dV = - \frac{1}{2} \int_r {\mathbf v_{E0,r}} \frac{T_{e0}}{N_0} \int_{\theta,z} \pdiff{N^2}{\theta} r d\theta dz dr.
\eeq
...
\begin{figure}[!ht]
\centerline{\includegraphics[]{flow_fourier_nf}}
